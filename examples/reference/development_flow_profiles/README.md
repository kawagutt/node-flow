...
These JSON files are **not loaded automatically** by NodeFlow unless you pass profile paths into `workflows.development_flow` params:
...
Alternatively, copy the nested dicts into your pipeline YAML under `params.spec_plan`, `params.implement`, and `params.review` by hand.
